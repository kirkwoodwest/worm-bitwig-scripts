...
function init() {
   ...
   //Hardware map
   hardware1 = new MidiFighterTwister(midi_out, midi_in, midiHandler1);
   ...
   trackHandler2 = new TrackHandler(bank2, cursorTrack2, massiveBank,0, "DRUM2");
   trackHandler3 = new TrackHandler(bank3, cursorTrack3, massiveBank,0, "DRUM2");
   trackHandler4 = new TrackHandler(bank4, cursorTrack4, massiveBank,0, "DRUM2");
   ...
   remoteHandler1  = new RemoteControlHandler(cursorDevice1,  cursorDevice1.createCursorRemoteControlsPage(8), remoteKnobs1, MFT_1_CHANNEL, hardware1, 0);
   remoteHandler2 = new RemoteControlHandler(cursorDevice2, cursorDevice2.createCursorRemoteControlsPage(8), remoteKnobs2, MFT_1_CHANNEL, hardware1, 1);
   remoteHandler3  = new RemoteControlHandler(cursorDevice3,  cursorDevice3.createCursorRemoteControlsPage(8), remoteKnobs3, MFT_1_CHANNEL,hardware1, 2);
   remoteHandler4 = new RemoteControlHandler(cursorDevice4, cursorDevice4.createCursorRemoteControlsPage(8), remoteKnobs4, MFT_1_CHANNEL, hardware1, 3);
...
function projectNameChanged(){
   ...
   for(i=0; i< remoteControlHandlers.length; i++){
      host.scheduleTask(doObject(remoteControlHandlers[i], remoteControlHandlers[i].resetPage), 3000+ (1000*i));
   }
}
